...
int menu()
{
    ...
    printf("             K- Listar Bicicletas por Color\n\n");
    printf("             L - Listar Bicicletas Por tipo\n\n");
    printf("             M - Listar Bicicletas con menor rodado\n\n");
    printf("             N - Listar Bicicletas Separados por tipo\n\n");
    printf("             O - Listar Bicicletas por Color y Tipo\n\n");
    printf("             P - Listar Color de bicicletas mas elegidos\n\n");
    printf("             Q - Salir\n\n");
    printf("------------------------------------------------\n\n");
